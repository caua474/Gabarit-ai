...
app.post("/api/gemini/chat", async (req, res) => {
  try {
    ...
    const selectedModel = customModel || "gemini-2.5-flash";
    const selectedTemp = typeof customTemp === "number" ? customTemp : 0.7;
    const defaultInstruction = "Você é um assistente de estudos inteligente e prestativo. Ajude o usuário de forma clara, didática, precisa e motivadora em Língua Portuguesa (Brasil). Caso receba imagens ou documentos, analise-os cuidadosamente e destaque pontos fundamentais de aprendizado.";
