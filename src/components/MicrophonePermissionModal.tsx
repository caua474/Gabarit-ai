    ...
    <AnimatePresence>
      ...
      >
        ...
        >
          ...
          >
            O <strong>GabaritaAí</strong> solicita acesso ao microfone para permitir que você faça perguntas por voz à Professora Gabi, pratique explicações no Método Feynman e use comandos falados de estudo.
          </p>
          ...
          <div className="p-3 rounded-2xl bg-indigo-50/70 dark:bg-indigo-950/40 border border-indigo-100 dark:border-indigo-900/60 text-xs text-indigo-900 dark:text-indigo-200 flex items-start gap-2.5">
            ...
            <div>
              <span className="font-bold block">Privacidade e Segurança</span>
              <span className="text-[11px] text-slate-600 dark:text-slate-400 leading-normal">
                Seu microfone só será acionado quando você clicar no botão de gravação. Nenhum áudio é gravado em segundo plano.
              </span>
            </div>
          </div>
