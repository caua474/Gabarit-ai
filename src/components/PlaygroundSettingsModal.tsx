...
export const PlaygroundSettingsModal: React.FC<PlaygroundSettingsModalProps> = ({
  ...
  const availableModels = [
    { id: 'gemini-2.5-flash', name: 'Gemini 2.5 Flash (Rápido e Multimodal - Padrão)' },
    { id: 'gemini-2.5-pro', name: 'Gemini 2.5 Pro (Raciocínio Complexo e Profundo)' },
    { id: 'gemini-3.6-flash', name: 'Gemini 3.6 Flash (Nova Geração)' },
  ];
