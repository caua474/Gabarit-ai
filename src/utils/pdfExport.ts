...
export function exportMaterialToPdf(material: StudyMaterial) {
  ...
  for (let i = 1; i <= totalPages; i++) {
    ...
    doc.text(`GabaritaAí • Página ${i} de ${totalPages}`, pageWidth / 2, pageHeight - 8, { align: 'center' });
  }
