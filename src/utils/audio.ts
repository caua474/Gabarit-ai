// Utilitário de Efeitos Sonoros usando Web Audio API
...
class SoundEffects {
  ...
  playSuccess() {
    try {
      ...
      // Frequências para som festivo de "pling" (E5 -> B5 / E6 -> B6)
      ...
      console.warn('Erro ao reproduzir som de sucesso:', e);
    }
  }

  // Som de Clique / Navegação
  playClick() {
    try {
      this.init();
      if (!this.ctx) return;
  ...
  playError() {
    try {
      ...
      console.warn('Erro ao reproduzir som de erro:', e);
    }
  }
}
