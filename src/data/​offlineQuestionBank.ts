...
export const OFFLINE_QUESTION_BANK: OfflineQuestion[] = [
  // Biologia
  {
    ...
    explicacao: 'O excesso de nutrientes (nitrogênio e fósforo) gera floração de algas. A camada de algas bloqueia a passagem da luz solar, impedindo a fotossíntese de plantas submersas. Bactérias decompositoras proliferam consumindo todo o O₂ dissolvido na água, sufocando os peixes.'
  },
  {
    id: 'bio_2',
    materia: 'Biologia & Meio Ambiente',
  ...
  // Física
  {
    ...
    opcoes: [
      'Diminui-se o comprimento do resistor, reduzindo a resistência e AUMENTANDO a corrente e a potência dissipada.',
